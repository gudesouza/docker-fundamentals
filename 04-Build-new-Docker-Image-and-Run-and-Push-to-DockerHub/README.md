...
docker build -t softwareoutput/mynginx_image1:v1 .
docker run --name mynginx1 -p 80:80 -d softwareoutput/mynginx_image1:v1
```
...
Replace your docker hub account Id
docker tag softwareoutput/mynginx_image1:v1 softwareoutput/mynginx_image1:v1-release
docker push softwareoutput/mynginx_image1:v1-release
```
